...
ARG DJANGO_IS_PRODUCTION
ARG DJANGO_SITE_URL
ARG DJANGO_EMAIL_FILE_PATH
...
ENV DJANGO_IS_PRODUCTION=${DJANGO_IS_PRODUCTION}
ENV DJANGO_SITE_URL=${DJANGO_SITE_URL}
ENV DJANGO_EMAIL_FILE_PATH=${DJANGO_EMAIL_FILE_PATH}
